// SEE THIS INSTEAD: src/app/utils/ollama.ts
...
//   console.log("In the ollama route")

//   if (stream) {
//     const result = await streamText({
//       // model: ollama(conversation.model.id, { numCtx: 22000 }),
//       model: ollama("llama3.2:1b", { numCtx: 22000 }),
